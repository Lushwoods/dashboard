...
export default function App() {
    ...
    if (!document.getElementById("dash-responsive")) {
      ...
      style.textContent = `
        *{box-sizing:border-box;}
        ...
        .dash-root{width:100%;max-width:100vw;}
  ...
  return (
    <div className="dash-root" style={{fontFamily:"'Poppins',sans-serif",background:C.bg,minHeight:"100vh",color:C.text,fontSize:13}}>
